                                ...
                                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="<?= $spk->code_product ?>" readonly>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="<?= $spk->qty_product ?>" readonly>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="<?= $spk->type_sample ?>" readonly>
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <div class="col-md bg-secondary text-light">
                                            <ul class="list-group">
                                                <li class="list-group-item bg-info mt-2">Material yang dipakai</li>
                                                <table>
